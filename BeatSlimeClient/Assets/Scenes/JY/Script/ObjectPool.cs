...
public class ObjectPool : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        PlayerObjectQueue = InsertQueue(Protocol.CONSTANTS.MAX_CLIENT - 1, OtherPlayerPrefeb, null);
    ...
    Queue<GameObject> InsertQueue(int count, GameObject prefeb, Transform tr)
    {
        ...
        {
            GameObject t_clone = Instantiate(prefeb, transform.position, Quaternion.identity);
