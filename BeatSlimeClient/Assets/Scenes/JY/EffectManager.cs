...
public class EffectManager : MonoBehaviour
{
    ...
    // 1방향 공격
    public void OneTileEffect(int start_x, int start_y, int start_z, int start_w, int speed)
    {

        GameObject go = Instantiate(TileEffectPrefab, GetHexCellPosition(start_x, start_y, start_z, start_w), Quaternion.identity);
