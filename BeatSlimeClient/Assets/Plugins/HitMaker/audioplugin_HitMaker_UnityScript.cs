...
public class audioplugin_HitMakerGUI : IAudioEffectPluginGUI
{
    public override string Name           { get { return "audioplugin_HitMaker"; } }
    public override string Description    { get { return "HitMaker"; } }
    public override string Vendor         { get { return "JUCE"; } }

    //==============================================================================
    [DllImport("audioplugin_HitMaker")] static extern System.IntPtr getRenderCallback();

    [DllImport("audioplugin_HitMaker")] static extern void unityInitialiseTexture (int id, System.IntPtr texture, int width, int height);

    [DllImport("audioplugin_HitMaker")] static extern void unityMouseDown (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_HitMaker")] static extern void unityMouseDrag (int id, float x, float y, EventModifiers mods, int button);
    [DllImport("audioplugin_HitMaker")] static extern void unityMouseUp   (int id, float x, float y, EventModifiers mods);

    [DllImport("audioplugin_HitMaker")] static extern void unityKeyEvent (int id, KeyCode code, EventModifiers mods, string name);

    [DllImport("audioplugin_HitMaker")] static extern void unitySetScreenBounds (int id, float x, float y, float w, float h);
