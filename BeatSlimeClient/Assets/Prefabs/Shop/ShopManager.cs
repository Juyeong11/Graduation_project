...
public class ShopManager : MonoBehaviour
{
    ...
    void Update()
    {
        skill_price[0].text = shopPrices.Skill1Prices[PM.skillLevelsContainer[0]+1].ToString();
        skill_price[1].text = shopPrices.Skill2Prices[PM.skillLevelsContainer[1]+1].ToString();
        skill_price[2].text = shopPrices.Skill3Prices[PM.skillLevelsContainer[2]+1].ToString();
    ...
    {
        FieldGameManager.Net.SendBuyPacket((byte)((skillNum-1)*4+PM.skillLevelsContainer[skillNum-1]+1));
    }
}
